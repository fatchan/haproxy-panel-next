...
If you have any questions, feel free to reach out to our support team.`);
			...
			if (process.env.SHKEEPER_WARNING_ENDPOINT) {
				fetch(process.env.SHKEEPER_WARNING_ENDPOINT)
					.then(r => console.log('sending SHKeeper callback warning, status:', r.status))
