...
export const nameToProcessors = {
	...
	[process.env.NEXT_PUBLIC_BACKENDS_MAP_NAME]: [parseJsonValues, showValues, filterToUserDomains],
	[process.env.NEXT_PUBLIC_HOSTS_MAP_NAME]: [parseJsonValues, showValues, filterToUserDomains],
